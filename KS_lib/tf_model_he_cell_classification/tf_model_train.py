...
from KS_lib.tf_model_he_cell_classification import tf_model_input
...
def define_graph(object_folder,checkpoint_folder, flags):
    ...
    # Calculate loss.
    loss_train = tf_model.loss(sigmoid_all_train, labels_train, curr_epoch, flags)
    loss_val = tf_model.loss(sigmoid_all_val, labels_val, curr_epoch, flags)
