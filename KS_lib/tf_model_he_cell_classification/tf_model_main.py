...
from KS_lib.tf_model_he_cell_classification import tf_model_test
from KS_lib.general import KScsv
import numpy as np

def main(nth_fold,mode,flags,test_images_list,result_path, he_dcis_segmentation_path, igpu):
    ...
    if mode == 'test_model':
        ...
        test_images_list = [[x[0]] for x in filename_list]
        test_coordinate_list = [[x[1]] for x in filename_list]
        tf_model_test.test(object_folder, model_path, test_images_list, test_coordinate_list, flags,
